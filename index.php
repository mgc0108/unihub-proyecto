...
// Añadir Examen/Trabajo (SIMPLIFICADO)
...
<div class="container py-4">
    <header class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="horario_semanal.php" class="btn btn-dark btn-sm rounded-pill">📅 Ver Horario</a>
    </header>
    ...
    <div class="row g-4">
        <div class="col-12 col-lg-7">
            ...
            <div class="card-custom">
                <h5 class="fw-800 mb-4">Clases de hoy (<?= $hoy_nombre ?>)</h5>
                ...
                <?php endforeach; else: ?>
                    <p class="text-muted small">No hay clases registradas.</p>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-5">
            <div class="card-custom bg-success text-white">
                <small class="text-uppercase fw-bold opacity-75">Hoy en la cafetería:</small>
                <h5 class="fw-800 mb-1"><?= $menuHoy ? $menuHoy['plato_principal'] : "Menú no disponible" ?></h5>
                <small class="opacity-75"><?= $menuHoy ? "Postre: " . $menuHoy['postre'] : "" ?></small>
            </div>

            <div class="card-custom">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h6 class="fw-800 mb-0">🎯 Entregas y Exámenes</h6>
                ...
                <?php foreach($proximosExamenes as $e): ?>
                    <div class="p-3 bg-light rounded-4 mb-2 d-flex justify-content-between align-items-center">
                        ...
                        <a href="?delete_ex=<?= $e['id'] ?>" class="text-danger fw-bold text-decoration-none" onclick="return confirm('¿Borrar?')">✕</a>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
